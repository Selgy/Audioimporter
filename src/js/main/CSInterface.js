...
(function () {
    ...
    function startRustServer() {
        ...
        const rustExecutablePath = path.join('C:', 'Program Files', 'Common Files', 'Adobe', 'CEP', 'extensions', 'AudioImporter', 'target', 'release', 'audio_importer.exe');
        console.log(`Starting Rust server from ${rustExecutablePath}`);
